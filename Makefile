...
#    Updated: 2019/03/14 14:23:13 by brobson          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	ft_bzero.c ft_itoa.c ft_memalloc.c ft_memccpy.c ft_memchr.c ft_toupper.c\
		...
		ft_convert_dec.c ft_intsize.c ft_get_next_line.c ft_strjoin_free.c\
		ft_convert_power.c ft_is_inbase.c ft_abs.c\
...
OBJS =  ft_bzero.o ft_itoa.o ft_memalloc.o ft_memccpy.o ft_memchr.o ft_memcmp.o\
		...
		ft_convert_dec.o ft_intsize.o ft_get_next_line.o ft_strjoin_free.o\
		ft_convert_power.o ft_is_inbase.o ft_abs.o\
